...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">CHUNGCHEONG Area Restaurant Review</h1>
	</div>
</div>
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form" action="/board/register_CHUNGCHEONG" method="post" enctype="multipart/form-data">
...
$(document).ready(function(){
	...
	$("#ListBtn").on("click",function(){
		FormObj.attr("action","/board/list_CHUNGCHEONG");
